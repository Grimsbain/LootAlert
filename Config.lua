...
Options:SetScript("OnShow", function()
    ...
    MinQuality.text:SetText(LootAlert_GetLootQualityText(MinQuality:GetValue()))
    ...
    if (IsAddOnLoaded("TheUndermineJournal") or IsAddOnLoaded("TradeskillMaster")) then
        ...
        UIDropDownMenu_SetText(SourceDropDownButton, LootAlert_GetSourceText(currentSource))
